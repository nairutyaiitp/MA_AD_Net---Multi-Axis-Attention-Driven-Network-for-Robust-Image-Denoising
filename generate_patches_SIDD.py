...
parser.add_argument('--src_dir', default='./datasets/SIDD/SIDD_Medium_Srgb/', type=str, help='Directory for full resolution images')
parser.add_argument('--tar_dir', default='./datasets/SIDD/train',type=str, help='Directory for image patches')
